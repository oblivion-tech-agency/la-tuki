export const TOUR_DATES = [
  ...
  },
  {
    ...
    image: '/images/flyers/viedma-0821.webp',
    ticketUrl: 'https://centralticket.net/Tukixaura',
  },
  {
    id: 'rincon-0822',
    date: '22/08',
    ...
    venue: 'Clúb Berlín',
    city: 'RINCÓN DE LOS SAUCES, NEUQUÉN',
    image: '/images/flyers/rincon-0822.webp',
    ticketUrl: 'https://centralticket.net/event/Rinconxtuki',
  },
  {
    id: 'malargue-0822',
    date: '22/08',
    ...
    venue: 'Clúb Montana',
    city: 'MALARGÜE, MENDOZA',
    image: '/images/flyers/malargue-0822.webp',
    ticketUrl: 'https://centralticket.net/event/Montanaxtuki',
  },
  {
    id: 'trelew-0822',
    date: '22/08',
    ...
    venue: 'Goat',
    city: 'TRELEW, CHUBUT',
    image: '/images/flyers/trelew-0822.webp',
    ticketUrl: 'https://centralticket.net/event/9990',
  },
  {
    id: 'pigue-0829',
    date: '29/08',
    ...
    venue: 'Amnesia',
    city: 'PIGÜÉ, BUENOS AIRES',
    image: '/images/flyers/pigue-0829.webp',
    ticketUrl: 'https://centralticket.net/event/Piguextuki',
  },
  {
    id: 'darregueira-0905',
    date: '05/09',
    fullDate: '2026-09-05',
    venue: 'Tamara Disco',
    city: 'DARREGUEIRA, BUENOS AIRES',
    image: '/images/flyers/darregueira-0905.webp',
    ticketUrl: 'https://centralticket.net/event/Tukixdarregueira',
  },
  {
    id: 'monte-0905',
    date: '05/09',
    fullDate: '2026-09-05',
    venue: 'El Faro',
    city: 'SAN MIGUEL DEL MONTE, BUENOS AIRES',
